function Inventory() constructor{
	...
	item_set = function(_name, _quantity, _sprite, _type, _weapon_equiping_arg){
	...
	item_add = function(_name, _quantity, _sprite, _type, _weapon_equiping_arg){
		var _index = item_find(_name);
		
		if _index >= 0{
			_inventory_items[_index].quantity += _quantity;
		} else {
			item_set(_name, _quantity, _sprite, _type, _weapon_equiping_arg);
	}
